...
def dir2olivedir(issue_dir: IssueDir, access_rights: dict) -> OliveIssueDir:
    ...
    return OliveIssueDir(issue_dir.journal, issue_dir.date, issue_dir.edition, issue_dir.path, rights=ar)


def olive_detect_issues(base_dir: str, access_rights: str, journal_filter: set = None, exclude: bool = False) \
        -> List[OliveIssueDir]:
