...
from text_importer.importers.mets_alto.core import import_issues as lux_import_issues
...
def main():
    ...
    result = lux_import_issues(issues, outp_dir, out_bucket, issue_class=LuxNewspaperIssue)
